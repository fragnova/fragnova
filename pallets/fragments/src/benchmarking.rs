...
benchmarks! {
	...
	create {
		...
		pallet_protos::Pallet::<T>::upload(RawOrigin::Signed(caller.clone()).into(), auth_data, references, (Categories::Chain(ChainCategories::Generic), <Vec<Vec<u8>>>::new()), None, None, immutable_data.clone())?;
