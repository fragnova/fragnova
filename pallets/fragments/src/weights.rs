...
//! Autogenerated weights for pallet_fragment
//!
...
/// Weight functions needed for pallet_fragment.
pub trait WeightInfo {
	fn create() -> Weight;
}

/// Weights for pallet_fragment using the Substrate node and recommended hardware.
